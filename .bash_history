...
git remote 
git remote add
git remote add gitpty https://github.com/gitPty/hello-world
ll .ssh/
vim .ssh/id_rsa.pub 
ssh-keygen -t rsa -C "2622114804@qq.com"
vim .ssh/id_rsa.pub 
mv .ssh/id_rsa.pub .ssh/id_rsa_2020/10/1.pub 
mv .ssh/id_rsa.pub .ssh/id_rsa_2020-10-1.pub 
ls .ssh/
ssh-keygen -t rsa -C "2622114804@qq.com"
vim .ssh/id_rsa
mv  .ssh/id_rsa_2020-10-1.pub  .ssh/id_rsa.pub
vim .ssh/id_rsa.pub 
ssh -T git@github.com
ls
cd scripts01/
git https://github.com/gitPty/hello-world.git
git init
cd ..
git init
git add scripts01/*
git commit -m "first commit"
git branch -M master
git remote add origin https://github.com/gitPty/hello-world.git
git push -u origin master
git pull https://github.com/gitPty/hello-world.git
git remote add origin https://github.com/gitPty/hello-world.git
git merge https://github.com/gitPty/hello-world.git
ls
cd git/
ls
cd ../scripts01/
...
git add README.md 
git commit -m "first commit"
git remote add origin git@github.com:gitPty/linux-c.git
git remote add linux-c  git@github.com:gitPty/linux-c.git
git push -u linux-c master
git push -u origin  master
git show
cd scripts01/
git show
...
git remote add linux-c git@github.com:gitPty/linux-c.git
git add scripts01/*
git push linux-c master
git remote show
git remote show linux-c
git remote rm linux-c
git remote show 
git remote -v
git remote add linux-c https://github.com/gitPty/linux-c.git
git remote -v
git pull linux-c
git add scripts01/*
git commit -m "sc-first-commit"
git push -u linux-c master
env
ls ~/.ssh/id_rsa
cat  ~/.ssh/id_rsa
...
git remote -v
dmesg|tail -n 10
cat /var/log/cron-20201018
cat /var/log/boot.log-20201021
...
git fetch linux-c
git ls-files
git ls-files linux -c
git add int.py
git commit -m "sc01-commit"
git push linux-c master
git push linux-c master -f
touch sc-commit.sh
git add sc-commit.sh 
git push linux-c master 
